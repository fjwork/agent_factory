...
async def main():
    ...
    await ask_agent("What can you do for me ?", session_service)

    await ask_agent("What is 2 multipled by  4 ?", session_service) 

    await ask_agent("What is 2 added to  4 ?", session_service)    

    await ask_agent("What is 4 multipled by 6 ?", session_service)        

    await ask_agent("What is 2 add to  4 then the result multiplied by 6?", session_service)
